...
//    bool         active;
	...
	Sprite      *sprite;
//	Item        *item;
	fix32        x, vel_x, next_x;
	fix32        y, vel_y, next_y;
	u16          vram;
...
#define goGetX(g)       (fix32ToInt((g)->x))
#define goGetY(g)       (fix32ToInt((g)->y))
#define goMoveSprite(g) (SPR_setPosition((g)->sprite, goGetX((g)), goGetY((g))))
